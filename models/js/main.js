...
function windowLoadInit() {
	...
	if ($header.length) {
		...
		jQuery('.page_header.table_section').on('affixed.bs.affix', function () {
			$header.parent().css({height: 80});
		});
		jQuery('.page_header.table_section').on('affixed-top.bs.affix', function () {
