 ...
 $(window).scroll(function(){ 
        if ($(this).scrollTop() > 50) { 
            ...
            $('.gotop').fadeIn();
             ...
             $('.menu-main-home5 ').css('float','unset !important');
          $('.menu_sticky_v3 ').removeClass('hidden_992');
          $('.icon_sticky_v3 ').removeClass('hidden_992');
          $('.menu_sticky_v4 ').removeClass('hidden_992');
             // --------social fixed------
      ...
      // -----end------------
          ...
          $('.menu_sticky_v3 ').addClass('hidden_992');
          $('.icon_sticky_v3 ').addClass('hidden_992');
          $('.menu_sticky_v4 ').addClass('hidden_992');
        } 
    }); 
...
$(function(){
  ...
  $('.icon_home_v3 .btn-search').on('click',function(){
      $('.form-search').css('right','0');
    });
  ...
  $('.icon_home_v3 .btn-cart').on('click',function(){
      $('.form-cart').css('right','0');
      $('.overlay').css('opacity','1').css('visibility','visible');
    });
...
//   ================
  var $status = $('.pagingInfo');
    var $slickElement = $('.js_slider_1');
    $slickElement.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide) {
        //currentSlide is undefined on init -- set it to 0 in this case (currentSlide is 0 based)
        var i = (currentSlide ? currentSlide : 0) + 1;
        $status.html('<span class="dot_current">0' + i  + '</span>' + '<span>0' +slick.slideCount + '</span>');
    });
  $('.js_slider_1').on('afterChange', function(event, slick, currentSlide) {
...
$('.open-sidebar').on('click',function(){
  ...
  $('.sidebar').css('right','0').css('opacity','1');
    $('.sidebar-full').css('right','0').css('opacity','1');
  ...
  $('.sidebar-full').css('right','-300px').css('opacity','0');
...
$('.js-btn-filter').on('click',function(){
  ...
  $(this).attr('data-click-state', 0);
  $('.sidebar-full').css('right','-2000px').css('opacity','0');
    $('.open-sidebar').css('background','#fff').css('transform','translateX(0)');;
  $('.open-sidebar i').css('color','#ee9051').css('transform','rotate(0)');
  $('.overlay').removeClass('active');
}
  ...
  $('.overlay').on('click',function(){
  $('.js-btn-filter').attr('data-click-state', 0);
  $('.sidebar-full').css('right','-2000px').css('opacity','0');
    $('.open-sidebar').css('background','#fff').css('transform','translateX(0)');;
  $('.open-sidebar i').css('color','#ee9051').css('transform','rotate(0)');
  $('.overlay').removeClass('active');
...
// ---------slide product detail-------------
 ...
 // ---------end-----------
  ...
  $(".close-promo").on("click",function(){
   $(".nixx-promotion").addClass("close-promotion");
});
  // ---------end-----------
  $('.slick-bestseller-v1').slick({
  dots:false,
  autoplay:false,
  speed: 1000,
  slidesToShow: 3,
  ...
  $('.js-product-quickview').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        asNavFor: '.js-click-product-quickview'
    });
  $('.js-click-product-quickview').slick({
        
        slidesToShow: 4,
        slidesToScroll: 1,
        asNavFor: '.js-product-quickview',
        dots: false,
        focusOnSelect: true,
        infinite: true,
        arrows: false,
  ...
  $(".quickview-close").on("click", function() {
        $(".quickview_popup").addClass("hidden");
    });
  // end
  // ============ newsletter
$('#email-modal .close , #email-modal .modal-overlay').on('click',function() {
      $('#email-modal').hide();
    });
// end
});