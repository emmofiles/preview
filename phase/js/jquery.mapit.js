...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			address: '<h2 class="map box-title light gray2 uppercase">The <span class="colored extrabold">Phase</span></h2><p class="bold source-sans gray2">Address 1, Area - County<br />Queens, New York</p><p>Tel.: +30 210 123 4567<br />Fax: +30 210 123 4567</p>',
			styles: 'GRAYSCALE',
			origins: [
				['37.936294', '23.947394'],
				['37.975669', '23.733868']
